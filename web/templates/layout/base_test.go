...
func TestBaseKanbanMoveTransactionsPreventVisibleRollback(t *testing.T) {
	...
	for _, want := range []string{
		...
		"kanbanBoardRequestGeneration",
		"latestAcceptedKanbanBoardRequestGeneration",
		"responseRequestGeneration < latestAcceptedKanbanBoardRequestGeneration",
		"pendingKanbanReconciliations",
		"data-kanban-reconciliation-generation",
		"__openVibelyKanbanReconciliationAccepted",
		"retryKanbanReconciliation",
		"clearKanbanMoveProjection",
		"data-kanban-reconciliation-generations",
		"kanbanReconciliationGenerations",
		"if (excludedGenerations && excludedGenerations.has(move.generation)) return",
		"applyPendingKanbanMovesToResponse(event.detail, new Set(reconciliationGenerations))",
		"reconciliationGenerations.forEach(finishKanbanReconciliation)",
		...
		"htmx:beforeSwap",
		"htmx:afterRequest",
		"forceKanbanAuthoritativeRefresh",
	} {
		if !strings.Contains(html, want) {
			t.Fatalf("kanban move controller missing %q", want)
		}
	}
}
...
func TestBase_DraggableCardsUseClosedHandCursorWhileActive(t *testing.T) {
	...
	for _, want := range []string{
		...
		"state.motions = state.dragCards.map(function(card)",
		"state.motions.forEach(function(motion)",
		"movePointerCard(motion, deltaX, deltaY)",
		"endPointerCardMotion(motion)",
...
func TestDarkMode_ButtonHoverParity(t *testing.T) {
	...
	expected := []string{
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn:hover:where(:not(:disabled):not(.btn-disabled)) {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-primary:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-secondary:hover:where(:not(:disabled):not(.btn-disabled)) {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-accent:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-info:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-success:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-warning:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-error:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-neutral:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-ghost:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-link:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-outline:hover:where(:not(:disabled):not(.btn-disabled)) {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-outline.btn-primary:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-outline.btn-secondary:hover:where(:not(:disabled):not(.btn-disabled)) {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-outline.btn-accent:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-outline.btn-info:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-outline.btn-success:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-outline.btn-warning:hover {",
		"[data-color-theme=\"openvibely-dark\"][data-theme=\"dark\"] .btn-outline.btn-error:hover {",
	}
	for _, fragment := range expected {
		if !strings.Contains(html, fragment) {
...
func TestLightMode_ButtonHoverParity(t *testing.T) {
	...
	expected := []string{
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn:hover:where(:not(:disabled):not(.btn-disabled)) {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-primary:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-secondary:hover:where(:not(:disabled):not(.btn-disabled)) {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-accent:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-info:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-success:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-warning:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-error:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-neutral:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-ghost:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-link:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-outline:hover:where(:not(:disabled):not(.btn-disabled)) {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-outline.btn-primary:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-outline.btn-secondary:hover:where(:not(:disabled):not(.btn-disabled)) {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-outline.btn-accent:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-outline.btn-info:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-outline.btn-success:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-outline.btn-warning:hover {",
		"[data-color-theme=\"openvibely-light\"][data-theme=\"light\"] .btn-outline.btn-error:hover {",
	}
	for _, fragment := range expected {
		if !strings.Contains(html, fragment) {
