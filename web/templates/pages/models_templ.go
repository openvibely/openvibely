	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(agents) == 0 {
			...
			for _, agent := range agents {
				...
				templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%f", agent.Temperature))
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%t", agent.IsDefault))
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs(string(agent.AuthMethod))
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", agent.MaxWorkers))
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d", agent.WorkerTimeout))
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(agent.OAuthClientID)
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var18, templ_7745c5c3_Err = templ.JoinStringErrs(maskedSecret(agent.OAuthClientSecret))
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var19, templ_7745c5c3_Err = templ.JoinStringErrs(agent.OAuthAuthorizeURL)
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var20, templ_7745c5c3_Err = templ.JoinStringErrs(agent.OAuthTokenURL)
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var21, templ_7745c5c3_Err = templ.JoinStringErrs(agent.OAuthScopes)
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var22, templ_7745c5c3_Err = templ.JoinStringErrs(agent.OllamaBaseURL)
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var23, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%t", agent.AutoStartTasks))
				if templ_7745c5c3_Err != nil {
				...
				if !agent.IsDefault {
					...
					templ_7745c5c3_Var24, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("/models/%s/set-default", agent.ID))
					if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var25, templ_7745c5c3_Err = templ.JoinStringErrs(agent.ID)
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var27, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%t", agent.IsDefault))
				if templ_7745c5c3_Err != nil {
				...
				if agent.IsOAuth() {
					...
					if !agent.HasValidOAuthToken() {
						...
						templ_7745c5c3_Var45, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("/models/%s/oauth/initiate", agent.ID))
						if templ_7745c5c3_Err != nil {
						...
						templ_7745c5c3_Var47, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("/models/%s/oauth/initiate", agent.ID))
						if templ_7745c5c3_Err != nil {
