...
const requestUserInputParams = `{"type":"object","properties":{"questions":{"type":"array","description":"Ask 1 to 3 questions. Put the recommended/default path first for each question and include a move-forward option for proceeding with sensible defaults when practical.","minItems":1,"maxItems":3,"items":{"type":"object","properties":{"id":{"type":"string","description":"Stable question id used in the answer result."},"question":{"type":"string","description":"Plain-text question to show to the user."},"options":{"type":"array","description":"Clickable choices. The first option should be the recommended/default path; include a move-forward/defaults option when practical.","minItems":2,"maxItems":3,"items":{"type":"object","properties":{"label":{"type":"string","description":"Clickable option label returned exactly when selected."},"description":{"type":"string","description":"Short plain-text explanation shown under the label."}},"required":["label","description"],"additionalProperties":false}}},"required":["id","question","options"],"additionalProperties":false}}},"required":["questions"],"additionalProperties":false}`
