...
func TestAutomationSaveHardensCustomNativeInboxPersistedProjectPrompt(t *testing.T) {
	...
	require.Contains(t, inboxTask.Prompt, "Call list_alerts without project_id, using decision_state=approved, implementation_task_linked=false")
	...
	require.Contains(t, inboxTask.Prompt, "Do not pass processing_state, read, type, or source")
	require.Contains(t, inboxTask.Prompt, "every recovery-eligible processing state")
