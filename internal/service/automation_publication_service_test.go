...
func TestAutomationSaveHardensCustomNativeInboxPersistedProjectPrompt(t *testing.T) {
	...
	require.Contains(t, inboxTask.Prompt, `Call list_alerts using project_id="", decision_state=approved, processing_state=all`)
	...
	require.Contains(t, inboxTask.Prompt, "provider/runtime boundary removes the non-semantic empty/all values")
