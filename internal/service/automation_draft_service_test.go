...
func TestNativeSDLCTemplateUsesAutomationOwnedPromptsMatchingBootstrapContract(t *testing.T) {
	...
	for _, required := range []string{
		"approved and unlinked state", "get_alert", "claim_alert",
	...
	require.Contains(t, inboxPrompt, "Call list_alerts with only a bounded limit, offset")
	...
	require.Contains(t, inboxPrompt, "Do not pass project_id, decision_state, processing_state")
