...
func (s *TaskService) GetThreadRenderMetadataWithPrompt(ctx context.Context, id string) (*models.Task, error) {
	return s.repo.GetThreadRenderMetadataWithPrompt(ctx, id)
}
