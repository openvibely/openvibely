...
- Provider-async function tools are not enabled. They remain deferred until OpenVibely has durable call and result-delivery tracking; ordinary runtime-tool grants and approval boundaries remain unchanged.
