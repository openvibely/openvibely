...
- **Tool calling**: 6 tools (`read_file`, `write_file`, `edit_file`, `bash`, `list_files`, `grep_search`). OpenAI and Anthropic agentic loops treat `MaxTurns=0` as no limit (explicit caps still supported)
